                ...
                <form action="<?=ADMIN;?>/currency/add" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="value" class="form-control" id="value" placeholder="Введите значение. Базовая валюта USD = 1. Иначе - введите курс относительно базовой валюты" required data-error="Допускаются цифры и десятичная точка" pattern="^[0-9.]{1,}$">
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
